...
motherboard(b650_tomahawk, "MSI MAG B650 Tomahawk", am5).
motherboard(z790_aorus_elite, "Gigabyte Z790 Aorus Elite", lga1700).
...
field_options(motherboard, Options) :-
	findall(option(Id, Label), motherboard(Id, Label, _Socket), Options).
